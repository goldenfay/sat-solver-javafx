...
public class SATInstance {
    ...
    public SATInstance(Pheromon phromon, int nbrVariables, int nbrClauses) {
        this.phromon = phromon;
    ...
    public Pheromon getPhromon() {
        return phromon;
    }

    public void setPhromon(Pheromon phromon) {
        this.phromon = phromon;
    }
